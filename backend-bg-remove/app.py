...
def remove_stamp_background(content: bytes, stamp_color: str = "auto", strength: int = 58) -> bytes:
    """Extract red/blue/black stamps from neutral paper without a paid model.

    The algorithm estimates uneven paper illumination locally, separates the dominant
    ink chroma from the paper, builds a soft alpha matte and recolors only the ink.
    It intentionally preserves broken/uneven physical-stamp texture.
    """
